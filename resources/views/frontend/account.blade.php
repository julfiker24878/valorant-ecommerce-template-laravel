                    ...
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $order->total }}</td>
                                <td>
                                    <a href="{{ route('invoice.download', $order->id) }}" class="btn btn-primary" target="_blank">Download Invoice</a>
                                    <a href="{{ route('send.invoice', $order->id) }}" class="btn btn-warning text-dark">Send Mail</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
