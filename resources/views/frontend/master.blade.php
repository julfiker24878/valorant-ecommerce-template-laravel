...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front/css/fontawesome.css') }}">
...
<body>
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/629106d57b967b1179919bd5/1g4385cm6';
        s1.charset='UTF-8';
                    ...
                    <div class="row align-items-center">
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="{{ url('/') }}">
                                    <img src="{{ asset('front/images/logo/logo_1x.png')}}" srcset="assets/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                                <div class="advance_serach">
                                    ...
                                    <div class="form_item">
                                        <input type="search" id="search_input" value="{{ @$_GET['q'] }}" name="search" placeholder="Search Prudcts...">
                                ...
                                <div class="allcategories_collapse {{ (Route::CurrentRouteName() == 'index'? '':'collapse') }}" id="allcategories_collapse">
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            ...
                                            <li><a href="shop_grid.html"><i class="icon icon-Starship"></i>{{ __($category->category_name) }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <ul class="header_icons_group ul_li_right">
                                 <li>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        @else
                                        <a href="{{ route('customer.register.form') }}">Login</a>
                                    @endauth
                                </li>
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="{{ url('/') }}">
                                        <img src="{{ asset('front/images/logo/logo_1x.png')}}" srcset="assets/images/logo/logo_2x.png 2x" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    ...
                                    <li><a href="#!"><img src="{{ asset('front/images/play_store.pn')}}g" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
