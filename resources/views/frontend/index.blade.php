                        ...
                        <div class="best-selling-products">
                            ...
                            <div class="product-area clearfix">
                                ...
                                <div class="grid">
                                    ...
                                    <div class="details">
                                        <h4><a href="{{ route('product.details', $product->id) }}">{{ __($product->product_name) }}</a></h4>
                                        <p><a href="#">{{ __($product->short_description) }} </a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span class="woocommerce-Price-currencySymbol">$</span>{{ ($product->after_discount) }}
                                                        &nbsp; &nbsp;
                                                        <span class="woocommerce-Price-currencySymbol"><strike class="text-secondary"> $</span>{{ ($product->product_price) }} </strike>
                                                    </bdi>
                                                </span>
                                            </ins>
                                        </span>
                                                                ...
                                                                <div class="product_details_content">
                                                                    ...
                                                                    <div class="quantity_wrap">
                                                                        ...
                                                                        <div class="total_price">
                                                                            Total: TK {{ $product->after_discount }}
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                ...
                                <div class="slider_item">
                                    <div class="category_boxed">
                                        <a href="#!">
                                            ...
                                            <span class="item_title">{{ __($category->category_name) }}</span>
                                        </a>
                                    </div>
                                </div>
                                @endforeach
                                ...
                                <div class="slider_item">
                                    <div class="category_boxed">
                                        <a href="#!">
                                            <span class="item_image">
                                                <img src="{{ asset('front/images/categories/category_1.png')}}" alt="image_not_found">
                                            </span>
                                            ...
                                            <div class="slider_item">
                                                <div class="small_product_layout">
                                                    <a class="item_image" href="shop_details.html">
                                                        <img src="{{ asset('uploads/products/preview')}}/{{ $best_product->preview }}" alt="image_not_found">
                                                    </a>
                                                    <div class="item_content">
                                                        <h3 class="item_title">
                                                            <a href="shop_details.html">{{ $best_product->product_name }}</a>
                                                        </h3>
                                                        <ul class="rating_star ul_li">
                                                            <li>
                                                                <i class="fas fa-star"></i>
                                                        ...
                                                        <div class="item_price">
                                                            <span>TK{{ $best_product->after_discount }}</span>
                                                            <del>TK{{ $best_product->product_price }}</del>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="row newarrivals_products">
                    ...
                    <div class="col col-lg-7">
                        <div class="new-arrivals-grids clearfix">
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{ asset('/uploads/products/preview/')}}/{{ $new_arrival->preview }}" alt>
                                    <div class="actions">
                                        <ul>
                                            <li>
                                                <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                            ...
                                            <li>
                                                <a class="quickview_btn" data-bs-toggle="modal" href="#product_id{{ $new_arrival->id }}" role="button" tabindex="0"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="details">
                                    <h4><a href="{{ route('product.details', $new_arrival->id) }}">{{ __($new_arrival->product_name) }}</a></h4>
                                    <p><a href="#">{{ __($new_arrival->short_description) }}</a></p>
                                    <span class="price">
                                        <ins>
                                            <span class="woocommerce-Price-amount amount">
                                                <bdi>
                                                    <span class="woocommerce-Price-currencySymbol">TK </span>{{ ($new_arrival->after_discount) }}
                                                </bdi>
                                            </span>
                                        </ins>
                                    </span>
                            ...
                            <div class="modal fade" id="product_id{{ $new_arrival->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalToggleLabel2">Product Quick View</h5>
                                            ...
                                            <div class="product_details">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product_details_content">
                                                                <h2 class="item_title">{{ __($new_arrival->product_name) }}</h2>
                                                                <p>
                                                                    {{ __($new_arrival->description) }}
                                                                </p>
                                                                <div class="item_review">
                                                                    <ul class="rating_star ul_li">
                                                                        <li><i class="fas fa-star"></i></li>
                                                                ...
                                                                <div class="item_price">
                                                                    <span>TK {{ ($new_arrival->after_discount) }}</span>
                                                                    <del>TK {{ ($new_arrival->product_price) }}</del>
                                                                </div>
                                                                <hr>
                                                                <div class="item_attribute">
                                                                    <h3 class="title_text">Options <span class="underline"></span></h3>
                                                                ...
                                                                <div class="quantity_wrap">
                                                                    ...
                                                                    <div class="total_price">
                                                                        Total: TK {{ ($new_arrival->after_discount) }}
                                                                    </div>
                                                                </div>
                ...
                <div class="viewed_products_wrap arrows_topright">
                    <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                        ...
                        <div class="slider_item col">
                            <div class="viewed_product_item">
                                <div class="item_image">
                                    <img src="{{ asset('front/images/viewed_products/viewed_product_img_3.png')}}" alt="image_not_found">
                                </div>
                                <div class="item_content">
                            ...
                            <div class="viewed_product_item">
                                <div class="item_image">
                                    <img src="{{ asset('front/images/viewed_products/viewed_product_img_4.png')}}" alt="image_not_found">
                                </div>
                                <div class="item_content">
