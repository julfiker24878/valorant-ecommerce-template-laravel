                        ...
                        <td class="text-center abc">
                            <form action="{{ url('/cart/update') }}" method="POST"> @csrf
                                <div class="quantity_input">
                                    ...
                                    <input name="quantity[{{ $cart->id }}]" class="input_number" type="text" value="{{ $cart->quantity }}" />
                                    <button type="button" class="input_number_increment">
                                        <i data-price="{{ $cart->rel_to_product->after_discount }}" class="fal fa-plus"></i>
                                    </button>
                                </div>
                        </td>
                        <td class="text-center abc">TK {{ $cart->rel_to_product->after_discount*$cart->quantity }}</td>
            ...
            <div class="row">
                ...
                <div class="col col-lg-6">
                    <ul class="btns_group ul_li_right">
                        ...
                        @endphp
                        <li><a class="btn btn_dark" href="{{ url('/checkout') }}">Prceed To Checkout</a></li>
                    </ul>
                </div>
            </form>
                <div class="col col-lg-6">
                ...
                <div class="cart_total_table">
                    ...
                    <ul class="ul_li_block">
                        ...
                        <li>
                            ...
                            <span class="total_price">TK {{ $total - ($total*$discount) / 100 }}</span>
                        </li>
                    </ul>
                </div>
            </div>
