    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12">
                ...
                <form method="post" class="checkout woocommerce-checkout" action="{{ url('/order/placed') }}"> @csrf
                    <div class="col2-set" id="customer_details">
                        <div class="coll-1">
                            ...
                            <p class="form-row form-row form-row-first validate-required" id="billing_first_name_field">
                                ...
                                <input type="text" readonly class="input-text " name="name" id="name" value="{{ Auth::guard('customerlogin')->user()->name }}" />
                            </p>
                            ...
                            <p class="form-row form-row form-row-first address-field update_totals_on_change validate-required" id="billing_country_field">
                                <label for="country_id" class="">Country <abbr class="required" title="required">*</abbr></label>
                        ...
                        <table class="shop_table woocommerce-checkout-review-order-table">
                            <tr class="cart-subtotal">
                                ...
                                <td>
                                    ...
                                    <span class="woocommerce-Price-amount sub_total"><span class="woocommerce-Price-currencySymbol">TK </span>{{ $sub_total }}</span>
                                </td>
                            </tr>
                            <tr class="cart-subtotal">
                                <th>Discount</th>
                                <td>
                                    ...
                                    <span class="woocommerce-Price-amount discount"><span class="woocommerce-Price-currencySymbol">TK </span>{{ session('discount') }}</span>
                                </td>
                            </tr>
                            <tr class="shipping">
