                    ...
                    <div class="sb_widget">
                        ...
                        <div class="filter_sidebar">
                            ...
                            <div class="fs_widget">
                                ...
                                <select id="category_id" class="form-select" size="3" aria-label="size 3 select example">
                            ...
                            <div class="fs_widget">
                                ...
                                <select id="color_id" class="form-select" size="3" aria-label="size 3 select example">
                            ...
                            <div class="fs_widget">
                                ...
                                <select id="size_id" class="form-select" size="3" aria-label="size 3 select example">
                            ...
                            <div class="product-area shop-grid-product-area clearfix">
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('/uploads/products/preview') }}/{{ $all_product->preview }}" alt />
                                        <div class="actions">
                                            <ul>
                                                <li>
                                                    <a href="#">
                                    ...
                                    <div class="details">
                                        <h4><a href="#">{{ $all_product->product_name }}</a></h4>
                                        <p><a href="#">{{ $all_product->short_description }}</a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi> <span class="woocommerce-Price-currencySymbol">TK</span>{{ $all_product->after_discount }}</bdi>
                                                </span>
                                            </ins>
                                        </span>
...
@section('footer_script')
    ...
    <script>
        $('.search_btn').click(function(){
            ...
            var link = "{{route('shop')}}"+"?q="+search_input+"&category_id="+category_id+"&color_id="+color_id+"&size_id="+size_id;
