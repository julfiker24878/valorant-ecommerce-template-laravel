...
<head>
    ...
    <link href="{{asset('dashboard_assets/css/all.min.css')}}" rel="stylesheet">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="{{ route('admin') }}" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Demo Menu</a>
                                <ul aria-expanded="false">
                                    <li><a href="./email-compose.html">Julfiker Ali</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('role') }}">Manage</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Colors & Sizes</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('color') }}">View Colors</a></li>
                            <li><a href="{{ route('size') }}">View Sizes</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
